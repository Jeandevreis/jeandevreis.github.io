  ...
  return (
    <div className="z-10 -mt-8 flex-1 flex flex-col justify-center items-start text-left">
      ...
      <h1 className="text-[26px] md:text-[30px] font-bold tracking-tight leading-snug text-[#002233] transition-colors duration-300 mt-2">
        ...
        <span className="text-[#075b85]">gestão corporativa</span> com tecnologia.
      </h1>

      {/* Subtexto */}
      <p className="mt-3 md:mt-4 text-[13.5px] md:text-[15px] text-[#002233]/65 max-w-lg leading-relaxed transition-colors duration-300">
        Analista de sistemas focado em otimizar processos através de ERPs como Protheus, Sankhya e SAP. Transformo complexidade fiscal e operacional em resultados eficientes para o seu negócio.
      </p>
